...
public class RegulatoryActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		FirebaseDatabase.getInstance().getReference().child("users").child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
				...
				public void onDataChange(DataSnapshot dataSnapshot) {
					...
					TextView tv1 = new TextView(RegulatoryActivity.this);
					tv1.setTextSize(15);
					tv1.setTextColor(Color.BLACK);

					TextView tv2 = new TextView(RegulatoryActivity.this);
					tv2.setTextSize(15);
					tv2.setTextColor(Color.BLACK);
					TextView tv3 = new TextView(RegulatoryActivity.this);
					tv3.setTextSize(15);
					tv3.setTextColor(Color.BLACK);
					TextView tv4 = new TextView(RegulatoryActivity.this);
					tv4.setTextSize(15);
					tv4.setTextColor(Color.BLACK);
					TextView tv5 = new TextView(RegulatoryActivity.this);
					tv5.setTextSize(15);
					...
					tv3.setText("Book - The Telecom Regulatory Authority of India");
					...
					TableRow tr0 = new TableRow(RegulatoryActivity.this);

					TableLayout layoutINNER = new TableLayout(RegulatoryActivity.this);
					...
					TableRow tr = new TableRow(RegulatoryActivity.this);
					tr.setLayoutParams(params);
					tr.addView(tv1);

					TableRow tr2 = new TableRow(RegulatoryActivity.this);
					tr2.setLayoutParams(params);
					tr2.addView(tv2);

					TableRow tr3 = new TableRow(RegulatoryActivity.this);
					tr3.setLayoutParams(params);
					tr3.addView(tv3);

					TableRow tr6 = new TableRow(RegulatoryActivity.this);
					tr6.setLayoutParams(params);
					tr6.addView(tv4);


					TableRow tr7 = new TableRow(RegulatoryActivity.this);

					Button paid = new Button(RegulatoryActivity.this);
					paid.setText("SEND");
					...
					TableRow tr8 = new TableRow(RegulatoryActivity.this);
