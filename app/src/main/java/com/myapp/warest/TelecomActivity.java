    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		FirebaseDatabase.getInstance().getReference().child("users").child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
				...
				public void onDataChange(DataSnapshot dataSnapshot) {
					...
					TextView tv1 = new TextView(TelecomActivity.this);
					tv1.setTextSize(13);
					tv1.setTextColor(Color.BLACK);

					TextView tv2 = new TextView(TelecomActivity.this);
					tv2.setTextSize(13);
					tv2.setTextColor(Color.BLACK);
					TextView tv3 = new TextView(TelecomActivity.this);
					tv3.setTextSize(13);
					tv3.setTextColor(Color.BLACK);
					TextView tv4 = new TextView(TelecomActivity.this);
					tv4.setTextSize(13);
					tv4.setTextColor(Color.BLACK);
					TextView tv5 = new TextView(TelecomActivity.this);
					tv5.setTextSize(13);
					...
					tv3.setText("Book - Telecommunication New Sign Posts to Old Roads");
					...
					TableRow tr0 = new TableRow(TelecomActivity.this);

					TableLayout layoutINNER = new TableLayout(TelecomActivity.this);
					...
					TableRow tr = new TableRow(TelecomActivity.this);
					tr.setLayoutParams(params);
					tr.addView(tv1);

					TableRow tr2 = new TableRow(TelecomActivity.this);
					tr2.setLayoutParams(params);
					tr2.addView(tv2);

					TableRow tr3 = new TableRow(TelecomActivity.this);
					tr3.setLayoutParams(params);
					tr3.addView(tv3);

					TableRow tr6 = new TableRow(TelecomActivity.this);
					tr6.setLayoutParams(params);
					tr6.addView(tv4);


					TableRow tr7 = new TableRow(TelecomActivity.this);

					Button paid = new Button(TelecomActivity.this);
					paid.setText("SEND");
					...
					TableRow tr8 = new TableRow(TelecomActivity.this);
