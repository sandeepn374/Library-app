    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		FirebaseDatabase.getInstance().getReference().child("users").child(uid).addListenerForSingleValueEvent(new ValueEventListener() {
				...
				public void onDataChange(DataSnapshot dataSnapshot) {
					...
					TextView tv1 = new TextView(LastActivity.this);
					tv1.setTextSize(14);
					tv1.setTextColor(Color.BLACK);

					TextView tv2 = new TextView(LastActivity.this);
					tv2.setTextSize(14);
					tv2.setTextColor(Color.BLACK);
					TextView tv3 = new TextView(LastActivity.this);
					tv3.setTextSize(14);
					tv3.setTextColor(Color.BLACK);
					TextView tv4 = new TextView(LastActivity.this);
					tv4.setTextSize(14);
					tv4.setTextColor(Color.BLACK);
					TextView tv5 = new TextView(LastActivity.this);
					tv5.setTextSize(14);
					...
					tv3.setText("Book-Telecom Management in Emerging Economics");
					...
					TableRow tr0 = new TableRow(LastActivity.this);

					TableLayout layoutINNER = new TableLayout(LastActivity.this);
					...
					TableRow tr = new TableRow(LastActivity.this);
					tr.setLayoutParams(params);
					tr.addView(tv1);

					TableRow tr2 = new TableRow(LastActivity.this);
					tr2.setLayoutParams(params);
					tr2.addView(tv2);

					TableRow tr3 = new TableRow(LastActivity.this);
					tr3.setLayoutParams(params);
					tr3.addView(tv3);

					TableRow tr6 = new TableRow(LastActivity.this);
					tr6.setLayoutParams(params);
					tr6.addView(tv4);


					TableRow tr7 = new TableRow(LastActivity.this);

					Button paid = new Button(LastActivity.this);
					paid.setText("SEND");
					...
					TableRow tr8 = new TableRow(LastActivity.this);
