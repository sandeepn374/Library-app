...
public class ViewCollegeProfile extends AppCompatActivity {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if(child.child("email").getValue().toString().equals(auth.getCurrentUser().getEmail())){
                        ...
                        branches.setText("Branches : "+child.child("branches").getValue().toString());
    ...
    public void onBackPressed(){
        Intent intent = new Intent(ViewCollegeProfile.this, OrganisationActivity.class);
