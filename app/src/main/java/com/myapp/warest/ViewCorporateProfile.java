...
public class ViewCorporateProfile extends AppCompatActivity {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot child : dataSnapshot.getChildren()) {
                    ...
                    if(child.child("email").getValue().toString().equals(auth.getCurrentUser().getEmail())){
                        ...
                        domain.setText("Domain : "+child.child("domain").getValue().toString());
    ...
    public void onBackPressed(){
        Intent intent = new Intent(ViewCorporateProfile.this, OrganisationActivity.class);
